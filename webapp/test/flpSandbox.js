		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Movements Ismail",
									"targetURL": "#zsd016movements-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zsd016movements-display": {
								"semanticObject": "zsd016movements",
								"action": "display",
								"description": "A Fiori application for Ismail&#x27;s exam.",
								"title": "Movements Ismail",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zsd016movements",
									"url": sap.ui.require.toUrl("zsd016movements")
								}
							}
						}
					}
